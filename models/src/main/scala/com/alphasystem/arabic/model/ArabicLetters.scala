...
object ArabicLetters {
  ...
  val LetterForwardSlash = ArabicLetter(ForwardSlash)
  val LetterTatweel = ArabicLetter(Tatweel)
  val LetterSpace = ArabicLetter(Space)
  val LetterComma = ArabicLetter(Comma)
  val LetterAlif = ArabicLetter(Alif)
  val LetterYa = ArabicLetter(Ya)
  val LetterWaw = ArabicLetter(Waw)
